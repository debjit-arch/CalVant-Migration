...
// import { Trash2, UploadCloud, Calendar, Check, ArrowUpDown, ArrowUp, ArrowDown } from "lucide-react";
...
//             const docA = getDoc(a);
//             const docB = getDoc(b);
//             valA = docA?.approvalDate ? new Date(docA.approvalDate).getTime() : 0;
//             valB = docB?.approvalDate ? new Date(docB.approvalDate).getTime() : 0;
//             break;
//           }
//           case "reviewDate": {
//             const docA = getDoc(a);
//             const docB = getDoc(b);
//             valA = docA?.nextApprovalDate ? new Date(docA.nextApprovalDate).getTime() : 0;
//             valB = docB?.nextApprovalDate ? new Date(docB.nextApprovalDate).getTime() : 0;
//             break;
//           }
//           case "docName":
...
//                 {/* Ownership */}
//                 <th style={{ padding: "12px 14px", textAlign: "center", borderBottom: "2px solid #e6e6e6", fontWeight: 600, whiteSpace: "nowrap" }}>
//                   Ownership
//                 </th>
...
//               {controlsLoading ? (
//                 <tr>
//                   <td colSpan="15" style={{ textAlign: "center", padding: "32px", color: "#667eea" }}>
//                     Loading policies from server…
//                   </td>
//                 </tr>
//               ) : filteredDocRows.length === 0 ? (
//                 <tr>
//                   <td colSpan="15" style={{ textAlign: "center", padding: "18px", color: "#7f8c8d" }}>
//                     No policies found
//                   </td>
//                 </tr>
//               ) : (
...
//                         }}
//                         onMouseEnter={(e) => {
//                           e.currentTarget.style.backgroundColor = isSoaLinked ? "#e6f9ed" : "#f8f9fa";
//                         }}
//                         onMouseLeave={(e) => {
...
//       {previewModalOpen && (
//         <div
//           style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(0,0,0,0.6)", display: "flex", justifyContent: "center", alignItems: "flex-start", paddingTop: "80px", zIndex: 999 }}
//         >
...
//       <footer
//         style={{ position: "fixed", bottom: 0, left: 0, width: "100%", background: "white", color: "#9ca3af", padding: "12px", textAlign: "center", fontSize: "13px", zIndex: 700 }}
//       >

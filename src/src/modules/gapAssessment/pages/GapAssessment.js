    ...
    <div style={pageStyle}>
      ...
      <div style={statsStyle}>
        ...
        <div
          ...
          onClick={() => router.push("/gap-assessment/history")}
        ...
        <div
          ...
          onClick={() => router.push("/gap-assessment/history?status=closed")}
          onMouseEnter={(e) => (e.currentTarget.style.transform = "translateY(-2px)")}
          onMouseLeave={(e) => (e.currentTarget.style.transform = "translateY(0)")}
        >
        ...
        <div
          ...
          onClick={() => router.push("/gap-assessment/history?status=open")}
          onMouseEnter={(e) => (e.currentTarget.style.transform = "translateY(-2px)")}
          onMouseLeave={(e) => (e.currentTarget.style.transform = "translateY(0)")}
        >
      ...
      <div style={actionsStyle}>
        <div
          ...
          onClick={() => router.push("/gap-assessment/new")}
